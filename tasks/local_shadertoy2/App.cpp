  ...
  , useVsync{true}
{
  ...
  etna::create_program("texture_processing", {LOCAL_SHADERTOY2_SHADERS_ROOT "shadertoy2.comp.spv"});
  ...
  "graphics",
  {
    LOCAL_SHADERTOY2_SHADERS_ROOT "shadertoy2.vert.spv",
    LOCAL_SHADERTOY2_SHADERS_ROOT "shadertoy2.frag.spv"
  });
